...
?>
	...
	<form enctype="multipart/form-data" class="form-horizontal" style="text-align:left;" action="noticia-slider-post.php" method="POST" >
		<fieldset>
			...
			<legend>Agregar Noticia</legend>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				  <input id="noticia_titulo" name="noticia_titulo" placeholder="" class="form-control input-md" required="" type="text">
                ...
                <div class="form-group">
				  ...
				  <div class="col-md-4">
				    <input type="text" id="noticia_categoria" name="noticia_categoria" class="form-control" />
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">                     
				    <textarea class="form-control" id="noticia_resumen" name="noticia_resumen"></textarea>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				  <input id="noticia_fuente" name="noticia_fuente" placeholder="" class="form-control input-md" type="text">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
					<input id="noticia_linkexterno" name="noticia_linkexterno" placeholder="Ingrese URL completa. Ej. http://www.google.com.ar" class="form-control input-md" type="text">
...
-->
                <input id="noticia_preview" type="hidden" name="noticia_preview" class="form-control" value="0" />
