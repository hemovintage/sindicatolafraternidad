...
?>
	...
	<form enctype="multipart/form-data" class="form-horizontal" style="text-align:left;" action="video-post.php" method="POST" >
		<fieldset>

			<!-- Form Name -->
			<legend>Agregar Video a Multimedia</legend>
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="video_titulo">Titulo</label>  
				  <div class="col-md-4">
				  <input id="video_titulo" name="video_titulo" placeholder="" class="form-control input-md" required="" type="text" value="">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
					<input id="video_id" name="video_id" placeholder="" class="form-control input-md" type="text" value="">
