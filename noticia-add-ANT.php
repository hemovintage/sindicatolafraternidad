		...
		<fieldset>
			...
			<legend>Agregar Noticia</legend>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
					<input id="noticia_linkexterno" name="noticia_linkexterno" placeholder="Ingrese unicamente el codigo de Video" class="form-control input-md" type="text">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				    <input type="text" value="" data-role="tagsinput" name="noticia_tags" name="noticia_tags" class="form-control"/>
				  </div>
				</div>
