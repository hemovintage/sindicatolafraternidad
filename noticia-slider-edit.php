...
*/
	...
	<form enctype="multipart/form-data" class="form-horizontal" style="text-align:left;" action="noticia-slider-post-edit.php" method="POST" >
	
		<fieldset>
			<!-- Form Name -->
			<legend>Editar Noticia Slider</legend>
                ...
                <div class="form-group">
				  ...
				  <div class="col-md-4">
				    <input type="text" id="noticia_categoria" name="noticia_categoria" class="form-control" value="<?php echo $getNoticia[0]['categoria']; ?>"/>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				  	<input id="noticia_linkexterno" name="noticia_linkexterno" placeholder="Ingrese URL completa. Ej. http://www.google.com.ar" class="form-control input-md" type="text" value="<?php echo $getNoticia[0]['url_externa']; ?>">
				  	<br>
				  	<span>es Youtube?</span>
                    <select id="noticia_is_video" name="noticia_is_video" class="form-control">
							<option value="0" <?php if(empty($getNoticia[0]['is_video'])){ echo 'selected="selected"';} ?>>No</option>
							<option value="1" <?php if(!empty($getNoticia[0]['is_video'])){ echo 'selected="selected"';} ?>>Si</option>
					</select> 
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				    ...
				    <button id="submit" name="submit" class="btn btn-primary" onclick="">Modificar/Guardar</button>
				  </div>
				</div>
...
$(".image-list li span").click(function() {
    if(confirm("Esta seguro que desea borrar esta imagen?")){
        ...
        $.ajax({
            type: "POST",
            url: "ajax/noticia-slider-imagen.php",
